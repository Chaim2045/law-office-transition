...
**הסבר:**
- **editPassword**: מאפשר קריאה של הסיסמה (לצורך אימות) אך מונע כתיבה דרך האפליקציה. זה מונע משינוי של הסיסמה ללא גישה ישירה ל-Firebase Console.
- **guideData**: מאפשר קריאה וכתיבה של כל נתוני המדריך. כאן ישמרו כל השינויים שתבצע באפליקציה.

**⚠️ חשוב:** כללים אלו מאפשרים לכל אחד לקרוא ולכתוב את הנתונים. לאבטחה טובה יותר, מומלץ להוסיף אימות משתמשים או להגביל לפי IP.
